...
class Generalidades_model extends CI_Model {
	...
	function insertar_generalidad($data){
		...
		if($this->db->insert('vyp_generalidades', array('id_generalidad' => $id_generalidad, 'pasaje' => $data['pasaje'], 'alojamiento' => $data['alojamiento']))){
			return "exito";
		}else{
			return "fracaso";
		}
	...
	function editar_generalidad($data){
		...
		if($this->db->update('vyp_generalidades', array('pasaje' => $data['pasaje'], 'alojamiento' => $data['alojamiento']))){
			return "exito";
		}else{
			return "fracaso";
		}
