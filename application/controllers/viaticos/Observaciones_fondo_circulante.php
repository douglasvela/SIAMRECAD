...
class Observaciones_fondo_circulante extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('viaticos/observaciones_3');
		$this->load->view('templates/footer');
	}

	public function tabla_observaciones(){
		$this->load->view('viaticos/observaciones_3/tabla_observaciones');
	}


	public function listado_observaciones(){
		$this->load->view('viaticos/observaciones_3/listado_observaciones');
	}
