	    ...
	    <div class="container-fluid">
	        ...
	        <div class="row page-titles">
	            <div class="align-self-center" align="center">
	                <h3 class="text-themecolor m-b-0 m-t-0">Viaticos por Actividad</h3>
	            </div>
	        </div>
	         <div class="row ">
	            <div class="col-lg-4" id="cnt_form" style="display: block;">
	                <div class="card">
	                    ...
	                    <div class="card-body b-t">
                            ...
                            <div align="right">
                            	<button type="button" onclick="mostrarReportePorActividad('vista')" class="btn waves-effect waves-light btn-success2"><i class="mdi mdi-file-pdf"></i> Vista Previa</button>
                            </div>
                            <br>
                            <div class="card-body b-t">
	                            	<div class="demo-radio-button">
