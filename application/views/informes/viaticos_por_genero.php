	                ...
	                <div class="card">
	                    ...
	                    <div class="card-body b-t">
                            ...
                            <div class="form-group" align="right">
                                 <button type="button" onclick="mostrarReportePorGenero('vista')" class="btn waves-effect waves-light btn-success2"><i class="mdi mdi-file-pdf"></i> Vista Preliminar</button>
                            </div>
                             <br>
                            <div class="card-body b-t">
