...
function RowPeque($data,$dibujacelda,$fuente,$v=true)
{
    //Calculate the height of the row
    $nb=0;
    for($i=0;$i<count($data);$i++)
...
function Footer()
{
    ...
    $this->leyendasColor(55,316,'Arial','B',10,135,8,'5ta Calle Oriente Barrio El Santuario, San Vicente, El Salvador',0,109,82);
    $this->leyendasColor(75,320,'Arial','B',10,135,8,('Créditos: 2347-3309, FAX: 2393-4555'),0,109,82);
