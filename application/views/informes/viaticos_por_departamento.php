...
<head>
	<title></title>
	<script>
		function mostrarReportePorDepto(tipo){
	        var anios = $("#anio_actual_depto").val();
	        if(anios){
	          var xhr = "<?php echo base_url()?>";
	          	 if(document.getElementById('radio_pdf').checked==true && tipo==""){ 
	         		window.open(xhr+"index.php/informes/menu_reportes/reporte_viaticos_x_depto/pdf/"+anios,"_blank");
	      		}else if(document.getElementById('radio_excel').checked==true && tipo==""){
	      			window.open(xhr+"index.php/informes/menu_reportes/reporte_viaticos_x_depto/excel/"+anios,"_blank");
	      		}else{
	      			var html="<embed src='"+xhr+"index.php/informes/menu_reportes/reporte_viaticos_x_depto/vista/"+anios+"'  width='780' height='400'>";
	    ...
	    <div class="container-fluid">
	        ...
	        <div class="row page-titles">
	            <div class="align-self-center" align="center">
	                <h3 class="text-themecolor m-b-0 m-t-0">Viaticos por Departamento</h3>
	            </div>
	        </div>
	                ...
	                <div class="card">
	                    ...
	                    <div class="card-body b-t">
							<div class="form-group">
                                ...
                                <input type="text" value="<?php echo date('Y'); ?>" class="date-own form-control" id="anio_actual_depto" name="anio_actual" placeholder="yyyy">
                            </div>
                             <div align="right">
                                <button type="button" onclick="mostrarReportePorDepto('vista')" class="btn waves-effect waves-light btn-success2"><i class="mdi mdi-view-dashboard"></i> Vista Previa</button>
                             </div>
                             <br>
                            <div class="card-body b-t">
	                         ...
	                         <div align="right">
	                            <button type="button" onclick="mostrarReportePorDepto('')" class="btn waves-effect waves-light btn-success2"><i class="mdi mdi-file-pdf"></i> Exportar Reporte</button>
	                            </div>
	                    </div>
	                </div>
	            </div>
