    ...
    <div class="message-box">
        <div class="message-widget">
        	...
        	<?php 
                    ...
                    $observacion = $this->db->query("SELECT o.*, u.nombre_completo FROM vyp_observacion_solicitud AS o JOIN org_usuario AS u ON o.nr_observador = u.nr AND o.id_mision = '".$id_mision."' ORDER BY fecha_hora DESC");
