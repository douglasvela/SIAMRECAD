        ...
        <div class="row page-titles">
            <div class="align-self-center" align="center">
                <h3 class="text-themecolor m-b-0 m-t-0">
                	<?php 
                		echo $titulo = ucfirst(strtolower("Solicitud de Viáticos y Pasajes")); 
                	?>
                	</h3>
            </div>
        </div>
                            ...
                            <form action="#" class="validation-wizard wizard-circle">
                                ...
                                <section>
                                    <div class="row">
                                    	<div class="col-lg-12">
                                    		<div class="row">
						                        <div class="form-group col-lg-2 m-b-15">   
						                        	<h5>Fecha: <span class="text-danger">*</span></h5>
						                        	<input type="text" class="form-control" id="datepicker-autoclose" placeholder="mm/dd/yyyy">                       
						                        </div>
						                    	<div class="form-group col-lg-4 m-b-15">   
						                        	<h5>Origen: <span class="text-danger">*</span></h5>                         
						                            <select id="origen" name="origen" class="select2" onchange="mostrarFormMenu()" style="width: 100%">
						                        ...
						                        <div class="form-group col-lg-4 m-b-15">
						                        	<h5>Destino: <span class="text-danger">*</span></h5>
						                            <select id="destino" name="destino" class="select2" onchange="mostrarFormMenu()" style="width: 100%">
                                    		...
                                    		<p class="m-b-0">Datos de la empresa visitada</p>
