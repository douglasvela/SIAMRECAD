...
<script type="text/javascript">   
    ...
    function tabla_observaciones(){    
        ...
        xmlhttpB.open("GET","<?php echo site_url(); ?>/viaticos/observaciones_fondo_circulante/tabla_observaciones",true);
        xmlhttpB.send(); 
    }
    ...
    function listado_observaciones(){    
        ...
        xmlhttpB.open("GET","<?php echo site_url(); ?>/viaticos/observaciones_fondo_circulante/listado_observaciones?id_mision="+gid_mision,true);
        xmlhttpB.send(); 
    }
    ...
    function eliminar_observacion(id_observacion){
        ajax = objetoAjax();
        ajax.open("POST", "<?php echo site_url(); ?>/viaticos/observaciones_fondo_circulante/eliminar_observacion", true);
    ...
    function verificar_observaciones(){
        ...
        ajax = objetoAjax();
        ajax.open("POST", "<?php echo site_url(); ?>/viaticos/observaciones_fondo_circulante/verificar_observaciones", true);
        ajax.onreadystatechange = function() {
            if (ajax.readyState == 4){
                if(ajax.responseText == "observaciones"){
                    swal({   
                        ...
                        if(estado_solicitud == "5"){    //si la solicitud es revisada por el jefe inmediato
                    ...
                    swal({   
                        ...
                        if(estado_solicitud == "5"){    //si la solicitud es revisada por el jefe inmediato
                            cambiar_estado_solicitud(7);    //enviar a revision a director o jefe de regional
                        }
                    });
                }else{
                    swal({ title: "¡Ups! Error", text: "Intentalo nuevamente.", type: "error", showConfirmButton: true });
    ...
    function cambiar_estado_solicitud(estado){
        ajax = objetoAjax();
        ajax.open("POST", "<?php echo site_url(); ?>/viaticos/observaciones_fondo_circulante/cambiar_estado_solicitud", true);
        ajax.onreadystatechange = function() {
            if (ajax.readyState == 4){
                if(ajax.responseText == "exito"){
