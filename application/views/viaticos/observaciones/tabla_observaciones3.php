        ...
        <div class="table-responsive">
            <table id="myTable3" class="table table-hover product-overview">
                ...
                <?php 
                    ...
                    $mision = $this->db->query("
                        SELECT m.*, a.nombre_vyp_actividades AS nombre_actividad 
                        FROM vyp_mision_oficial AS m 
                        JOIN vyp_actividades AS a 
                            ON m.id_actividad_realizada = a.id_vyp_actividades AND m.estado = 5 
                        JOIN sir_empleado_informacion_laboral AS ei ON ei.id_empleado_informacion_laboral = m.id_empleado_informacion_laboral
                        JOIN org_linea_trabajo AS lt ON lt.id_linea_trabajo = ei.id_linea_trabajo ".$lt." ORDER BY m.fecha_solicitud DESC");
