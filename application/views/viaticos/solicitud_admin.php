                ...
                <div class="card">
                    ...
                    <div class="card-body b-t">
                        ...
                        <div id="cnt_mision">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-3 <?php if($navegatorless){ echo "pull-left"; } ?>">   
                                    <h5>Fecha solicitud: <span class="text-danger">*</span></h5>
                                    <input type="text" pattern="\d{1,2}-\d{1,2}-\d{4}" required="" class="form-control" id="fecha_solicitud" name="fecha_solicitud" placeholder="dd-mm-yyyy">
                                </div> 
                                ...
                                <div class="col-lg-3 <?php if($navegatorless){ echo "pull-left"; } ?>" align="center" style="display: none;">
    ...
    $("#formajax").on("submit", function(e){
        ...
        if(($("#fecha_mision_inicio").val() == "" || $("#fecha_mision_inicio").val() == "") && $("#band").val() != "delete"){
            ...
            if(validar_justificacion_mision()){
                ...
                $.ajax({
                        type:  'POST',
                        url:   '<?php echo site_url(); ?>/viaticos/solicitud_viatico/gestionar_mision2',
                        dataType: "html",
                        data: formData,
                        cache: false,
                        contentType: false,
