<div class="table-responsive">
    <table class="table table-hover product-overview" width="100%">
        ...
        <?php 
            ...
            $bitacora = $this->db->query("SELECT b.*, u.nombre_completo FROM vyp_bitacora_solicitud_pasaje AS b JOIN org_usuario AS u ON u.nr = b.nr_persona_actualiza AND id_mision = '".$id_mision."' ");
          ...
          //   echo "<td>INICIÓ EL PLAZO PARA CREAR SU SOLICITUD</td>";
