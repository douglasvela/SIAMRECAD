...
<script type="text/javascript">   
    ...
    function tabla_observaciones(){    
        ...
        xmlhttpB.open("GET","<?php echo site_url(); ?>/pasajes/solicitud_aprobada_pasajes/tabla_observaciones",true);
        xmlhttpB.send(); 
    }
...
$(function(){     
    $("#formajax2").on("submit", function(e){
        ...
        $.ajax({
            type:  'POST',
            url:   '<?php echo site_url(); ?>/pasajes/observaciones_fondo_circulante/otra_observacion',
            data: formData,
            cache: false
        })
        .done(function(res){
