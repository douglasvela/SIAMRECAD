...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-01-2018 a las 06:17:47
...
(1, 'Incompleta'),
(2, 'Revisión jefe inmediato'),
(3, 'Observaciones del jefe inmediato'),
(4, 'Revisión del director o jefe de regional'),
(5, 'Observaciones del director o jefe de regional'),
(6, 'Revisión del Fondo Circulante del Monto Fijo'),
(7, 'Observaciones del Fondo Circulante del Monto Fijo'),
(8, 'Aprobada'),
(9, 'Pagada');
...
--
ALTER TABLE `vyp_estado_solicitud`
  MODIFY `id_estado_solicitud` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
